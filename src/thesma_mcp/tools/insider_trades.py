...
async def get_insider_trades(
    ...
    try:
        if ticker:
            ...
            response = await app.client.insider_trades.list(cik, from_date=from_date, trade_type=type, per_page=limit)
            ...
            response = await app.client.insider_trades.list_all(from_date=from_date, per_page=limit)
